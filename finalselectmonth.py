...
file_name = 'predictions_10000.csv'
download_path = "./predictions_10000.csv"
...
for day in range(1, 31):
    ...
    ax.set_title('Demand Prediction by hour for day {} in {}, {}'.format(day, selected_city, selected_month_name))
